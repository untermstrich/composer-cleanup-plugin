...
class CleanupRules
{
    public static function getRules()
    {
        ...
        return array(
            ...
            'markbaker/matrix'                      => array($docs, $tests, '.github'),
            ...
            'microsoft/microsoft-graph'             => array($docs, $tests),
            'mockery/mockery'                       => array($docs, $tests),
            'monolog/monolog'                       => array($docs, $tests),
            'myclabs/php-enum'                      => array($docs, $tests),
            ...
            'setasign/fpdf'                         => array($docs, $tests, 'changelog.htm tutorial'),
