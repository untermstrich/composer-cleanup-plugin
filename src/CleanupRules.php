...
class CleanupRules
{
    public static function getRules()
    {
        ...
        $tests = '.travis.yml .scrutinizer.yml phpcs.xml* phpcs.php phpunit.xml* phpunit.php test tests Tests travis patchwork.json .gitignore .editorconfig .php_cs* pullapprove.yml';
